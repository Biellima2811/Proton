...
public class App extends Application {
    ...
    public void init() throws Exception {
        // 1. Inicia o Gerador de Logs (A pasta "logs" vai voltar a aparecer!)
        com.mycompany.proton.util.GerenciadorDeLog.iniciar();

        // 2. MAGIA: Valida e atualiza a estrutura do banco de dados sozinha
        com.mycompany.proton.util.DatabaseMigration.executarMigracoes();

        // 3. Inicia tarefas de background (Agendamento de Backup)
        com.mycompany.proton.service.BackupScheduler.iniciarAgendamento();
    }
    ...
    public void start(Stage stage) throws IOException {
        // Escutador Global de Exceções não tratadas (Agora usa a nossa classe limpa!)
        Thread.setDefaultUncaughtExceptionHandler(new com.mycompany.proton.util.GlobalExceptionHandler());
